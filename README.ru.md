 ...
 * Файл готов
 * Если не работает пишите [СЮДА](https://github.com/DENNKA/SubtitleShaker/issues/new) **обязательно** прикладывайте свои файлы
...
* Пропишите нужные параметры в этом файле настроек
  ...
  Перевод:
    * **1-100 -m translate -f en -to ru**  
    [Список кодов языков](docs/Language_codes.ru.md)
